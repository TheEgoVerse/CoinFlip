...
export const coinFlip = async (event, setAlert, setDisableBtn, account) => {
    ...
    try {
        ...
        let tokenContract = new web3.eth.Contract(tokenABI, tokenAddress, { from: fromAddress })

        let tokenData = tokenContract.methods.approve(contractAddress, amount).encodeABI()
